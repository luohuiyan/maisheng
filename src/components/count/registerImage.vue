<template>
    <div class="register1">
        <div class="registerTab">
            ...
            <span class="regRealCount">
              <router-link to="/">注册真实账户</router-link>
            </span>
        </div>
        <div class="commonLoginPd">
            <h3 class="registerTitle imageTitle">10000美元模拟资金，立即免费试用！</h3>
          <form action="">
            ...
            <p class="cardCue">感谢您选择Master Select Group Limited (MSG)！<br>模拟账户的有效期为申请成功后即日起15天的试用期。</p>
            <div class="btnOter">
              <p class="commonBtn"><router-link to="/registerImageSuccess">完成</router-link></p>
            </div>
