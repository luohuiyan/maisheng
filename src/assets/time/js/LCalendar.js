            ...
            function setDateGearTooth() {
                ...
                if (date_yy && date_yy.getAttribute("val")) {
                    ...
                    for (var p = 0; p <= passY - 1; p++) {
                        itemStr += "<div class='tooth'>" + (_self.minY + p) +'<span style="font-size: 16px;padding-left: 5px;">年</span>'+ "</div>";
                    }
                ...
                if (date_mm && date_mm.getAttribute("val")) {
                    ...
                    for (var p = 0; p < maxM - minM + 1; p++) {
                        itemStr += "<div class='tooth'>" + (minM + p + 1) +"<span style='font-size: 16px;padding-left: 5px;'>月</span>"+ "</div>";
                    }
                ...
                if (date_dd && date_dd.getAttribute("val")) {
                    ...
                    for (var p = 0; p < maxD - minD + 1; p++) {
                        itemStr += "<div class='tooth'>" + (minD + p + 1)+"<span style='font-size: 16px;padding-left: 5px;'>日</span>" + "</div>";
                    }
